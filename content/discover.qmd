...
Bienvenue sur le SSP Cloud, plateforme mutualisée de traitement de données ("Datalab"), destinée aux statisticiens et _data scientists_ au sein du système statistique européens au delà. Ce tutoriel propose une visite guidée du Datalab pour être rapidement opérationnel dans l'utilisation de ses services.
...
* De façon général sur [le Slack Onyxia](https://join.slack.com/t/3innovation/shared_invite/zt-1bo6y53oy-Y~zKzR2SRg37pq5oYgiPuA) dans le canal spécifique SSP Cloud. Toute question sur l'utilisation du SSP Cloud ou suggestion d'amélioration y sont les bienvenues.
...
Welcome to the SSP Cloud, a shared self-service platform for data processing ("Datalab"), designed for statisticians and data scientists working for the European Statistical System. This tutorial provides a guided tour of the Datalab to quickly get you up and running with its services.
...
Support and assistance for using the SSP Cloud are provided through two communication tools:

* Generally on [the Onyxia Slack](https://join.slack.com/t/3innovation/shared_invite/zt-1bo6y53oy-Y~zKzR2SRg37pq5oYgiPuA) in the specific SSP Cloud channel. Any questions about using the SSP Cloud or suggestions for improvement are welcome there.
