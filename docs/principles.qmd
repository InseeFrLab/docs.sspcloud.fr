...
{% hint style="info" %} Onyxia, Datalab SSP Cloud: What are the differences?

[Onyxia](https://github.com/InseeFrLab/onyxia.git) is an open-source project that provides a web application for accessing data science services. The [Datalab SSP Cloud](https://datalab.sspcloud.fr/home) is an instance of the Onyxia project hosted at Insee. {% endhint %}
...
![Fundamental building blocks of Datalab Onyxia](img/onyxia-components.png)
...
![A comprehensive service catalog for data science projects](img/onyxia-catalog.png)
