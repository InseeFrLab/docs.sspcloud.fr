...
Pour apprendre à utiliser cet onglet, voir la [page dédiée](/docs/version-control.html).
...
Pour apprendre à utiliser cet onglet, voir la [page dédiée](/docs/secrets.html).
...
To learn how to use this tab, see the [dedicated page](/docs/version-control.html).
...
To learn how to use this tab, see the [dedicated page](/docs/secrets.html).
